...
const doctorsData = [
    ...
    { id: 8, name: 'Dr. Smith', areas: ['Downtown', 'Hospital District'],img:'./jnjm/10.png' },
    { id: 9, name: 'Dr. Davis', areas: ['Suburbia', 'Hospital District'] ,img:'./jnjm/8.png'},
    { id: 10, name: 'Dr. Smith', areas: ['Downtown', 'Hospital District'] ,img:'./jnjm/9.png'},
  ];
